<template>
  <div>
    ...
    <div class="section">
      ...
      <p>
        Our weekly meetings consist of us working enthusiastically on projects that will make tasks easier for the student body and faculty. In part with the collaborative spirit seen in companies, students and teacher move around getting help and
        offering it. We keep track of all of our projects to ensure students work efficiently and to keep our “clients” updated. In their small groups, while working on projects, students learn valuable life lessons on how to keep friendly relations with
        clients and how to solve coding/engineering/design based real-life problems by sharing their knowledge with their peers to ultimately create a project that will benefit the community.
      </p>
    </div>
  </div>
</template>
